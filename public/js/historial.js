...
function renderHistorial(ventas, dias) {
  ...
  const usdChicha = ventas.filter(v => v.moneda === 'USD' && v.tipo_producto === 'chicha')
  ...
  totalsEl.innerHTML = `
    ...
    <div class="ht-item"><div class="ht-label">Chichas</div><div class="ht-value usd">$${fmtCurrency(usdChicha)}</div></div>
